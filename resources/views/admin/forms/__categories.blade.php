...
@section('admin-content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title"><span>1</span> <a data-toggle="collapse" data-parent="#faq" href="#my-account-1">Список всех категорий</a></h5>
        </div>
                                    ...
                                    @foreach($categories as $category)
                                        <form action="{{ route('admin.category.delete', [$category['id']]) }}" method="POST">
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-name"><a href="">{{ $category['name'] }}</a></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
